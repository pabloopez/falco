...
cmdline_options::cmdline_options()
	: event_buffer_format(sinsp_evt::PF_NORMAL),
	  m_cmdline_opts("Falco", "Container/Cloud-friendly runtime security tool")
{
	define();
}
...
void cmdline_options::define()
{
	m_cmdline_opts.add_options()
		...
		("list",                          "List all defined fields. If <source> is provided, only list those fields for the source <source>. Current values for <source> are \"syscall\", \"k8s_audit\", or any source from a configured source plugin", cxxopts::value(list_flds_source)->implicit_value("all"), "<source>")
